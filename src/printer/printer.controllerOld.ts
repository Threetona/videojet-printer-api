...
// export class PrinterControllerOld {
...
//         try {
//             const result =
//                 await this.printerService.sendMultyCommandsToPrinter(commands);
//             return {
//                 status: 'success',
...
//         type: [CommandEntity],
//     })
//     async sendSingleCommand(@Body() commandDto: CommandDto2) {
//         try {
//             const result =
//                 await this.printerService.sendSingleCommandsToPrinter(
//                     commandDto,
//                 );
